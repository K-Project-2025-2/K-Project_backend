...
public class LostAndFoundController {
    ...
    @PostMapping
    public ResponseEntity<LostItemReportResponse> reportLostItem(@AuthenticationPrincipal String email, @RequestBody LostItemReportRequest request) {
        LostItemReportResponse response = lostAndFoundService.reportLostItem(email, request);
